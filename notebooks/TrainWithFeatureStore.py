...
dbutils.widgets.text("experiment_name", "/mlops-cleanaway/mlops-cleanaway-experiment-test", label="MLflow experiment name")

# MLflow registered model name to use for the trained mode..
dbutils.widgets.text("model_name", "mlops-cleanaway-model-test", label="Model Name")
