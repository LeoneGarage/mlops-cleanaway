...
module "azure_create_sp" {
  ...
  service_principal_name       = "mlops-cleanaway-cicd"
  project_directory_path       = "/mlops-cleanaway"
  azure_tenant_id              = var.azure_tenant_id
  service_principal_group_name = "mlops-cleanaway-service-principals"
}
...
provider "databricks" {
  alias = "staging_sp"
  host  = "https://adb-8460772231412889.9.azuredatabricks.net"
